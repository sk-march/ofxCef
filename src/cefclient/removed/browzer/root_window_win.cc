...
void RootWindowWin::CreateRootWindow(const CefBrowserSettings& settings) {
  ...
  const std::wstring& window_title = L"Miku Miku Metaverse";// GetResourceString(IDS_APP_TITLE);
  const std::wstring& window_class = L"CEFCLIENT";// GetResourceString(IDC_CEFCLIENT);
